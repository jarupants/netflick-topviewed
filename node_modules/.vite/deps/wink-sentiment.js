...
// ../../../../../../node_modules/wink-sentiment/src/emojis.js
var require_emojis = __commonJS({
  "../../../../../../node_modules/wink-sentiment/src/emojis.js"(exports, module) {
    var emojis = {
      "😂": 1,
      "❤": 4,
      "♥": 3,
...
// ../../../../../../node_modules/wink-sentiment/src/afinn-en-165.js
var require_afinn_en_165 = __commonJS({
  "../../../../../../node_modules/wink-sentiment/src/afinn-en-165.js"(exports, module) {
    var afinn = {
      abandon: -2,
      abandoned: -2,
      abandons: -2,
...
// ../../../../../../node_modules/wink-sentiment/src/emoticons.js
var require_emoticons = __commonJS({
  "../../../../../../node_modules/wink-sentiment/src/emoticons.js"(exports, module) {
    var emoticons = {
      ":)": 2,
      ":(": -2,
      ":|": -1,
...
// ../../../../../../node_modules/wink-sentiment/src/negations.js
var require_negations = __commonJS({
  "../../../../../../node_modules/wink-sentiment/src/negations.js"(exports, module) {
    var negations = {
      never: true,
      none: true,
      no: true,
...
// ../../../../../../node_modules/wink-sentiment/src/afinn-en-165-2grams.js
var require_afinn_en_165_2grams = __commonJS({
  "../../../../../../node_modules/wink-sentiment/src/afinn-en-165-2grams.js"(exports, module) {
    var afinn2Grams = {
      bad: {
        luck: -2,
        fit: -1
...
var require_eng_contractions = __commonJS({
  "../../../../../../node_modules/wink-tokenizer/src/eng-contractions.js"(exports, module) {
    var contractions = /* @__PURE__ */ Object.create(null);
    var word = "word";
...
var require_wink_tokenizer = __commonJS({
  "../../../../../../node_modules/wink-tokenizer/src/wink-tokenizer.js"(exports, module) {
    var emojiRegex = require_emoji_regex();
    var contractions = require_eng_contractions();
    var rgxSpaces = /\s+/g;
    ...
    var tokenizer = function() {
          ...
          if (k < matches.length) {
            if (tag === "word") {
              ...
              if (rgxContraction.test(aword)) {
                ...
                tokens.push({ value: aword, tag });
              }
            } else tokens.push({ value: matches[k], tag });
          }
          k += 1;
        }
        return tokens;
      ...
      var defineConfig = function(config) {
        if (typeof config === "object" && Object.keys(config).length) {
          rgxs = rgxsMaster.filter(function(rgx) {
            ...
            return cc === void 0 || cc === null || !!cc;
          });
        } else rgxs = [];
        const uniqueCats = /* @__PURE__ */ Object.create(null);
      ...
      var addRegex = function(regex, tag, fingerprintCode) {
        ...
        rgxs.unshift({ regex, category: tag });
      };
      defineConfig({ quoted_phrase: false });
...
// ../../../../../../node_modules/wink-sentiment/src/wink-sentiment.js
var require_wink_sentiment = __commonJS({
  "../../../../../../node_modules/wink-sentiment/src/wink-sentiment.js"(exports, module) {
    var emojis = require_emojis();
    var afinn = require_afinn_en_165();
    var emoticons = require_emoticons();
    var negations = require_negations();
    var affin2Grams = require_afinn_en_165_2grams();
    var tokenize = require_wink_tokenizer()().tokenize;
    ...
    var sentiment = function(phrase) {
      ...
      var ss = 0;
      var hss = 0;
      var sentiHashtags = 0, sentiWords = 0;
      var words = 0;
      ...
      for (k = 0, kmax = tokenizedPhrase.length; k < kmax; k += 1) {
        ...
        switch (tkn.tag) {
          ...
          case "word":
            t = t.toLowerCase();
            wc = 1;
            if (k < kmax - 1 && affin2Grams[t] && affin2Grams[t][tokenizedPhrase[k + 1].value.toLowerCase()] !== void 0) {
...
export default require_wink_sentiment();
//# sourceMappingURL=wink-sentiment.js.map
